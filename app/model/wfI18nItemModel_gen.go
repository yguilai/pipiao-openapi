...
var (
	...
	cacheWfI18nItemNameLangPrefix       = "cache:wfI18nItem:name:lang:"
...
type (
	wfI18nItemModel interface {
		...
		FindOneByNameLang(ctx context.Context, name string, lang string) (*WfI18nItem, error)
...
func (m *defaultWfI18nItemModel) Delete(ctx context.Context, id int64) error {
	...
	wfI18nItemNameLangKey := fmt.Sprintf("%s%v:%v", cacheWfI18nItemNameLangPrefix, data.Name, data.Lang)
	...
	}, wfI18nItemIdKey, wfI18nItemNameLangKey, wfI18nItemUniqueNameLangKey)
	return err
}
...
func (m *defaultWfI18nItemModel) FindOneByNameLang(ctx context.Context, name string, lang string) (*WfI18nItem, error) {
	wfI18nItemNameLangKey := fmt.Sprintf("%s%v:%v", cacheWfI18nItemNameLangPrefix, name, lang)
	var resp WfI18nItem
	err := m.QueryRowIndexCtx(ctx, &resp, wfI18nItemNameLangKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
